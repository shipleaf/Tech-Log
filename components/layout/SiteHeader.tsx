...
export function SiteHeader() {
  return (
    <header className="sticky top-0 z-50 h-16 border-b border-border bg-background text-foreground">
      <div className="mx-auto flex h-16 w-full max-w-[1440px] items-center justify-between gap-4 px-6 md:px-10">
        ...
        <nav className="flex items-center gap-5 text-sm font-medium text-foreground">
          ...
          <Link href="/blog" className="transition-colors hover:text-muted-foreground">
            블로그
          </Link>
        </nav>
      </div>
